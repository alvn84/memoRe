...
class _FolderDetailScreenState extends State<FolderDetailScreen> {
  ...
  Future<void> _loadNotes() async {
    ...
    writtenDates =
        prefs.getStringList('${widget.folderName}_writtenDates') ?? [];
    ...
    await prefs.setStringList(
        '${widget.folderName}_writtenDates', writtenDates);
  }
                ...
                child: noteContents.isEmpty
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          try {
                            final deltaJson =
                                jsonDecode(deltaString) as List<dynamic>;
                          ...
                          final writeDate = (index < writtenDates.length)
                              ? writtenDates[index]
                              : 'Unknown';
                                    ...
                                    TextButton(
                                      onPressed: () async {
                                        ...
                                        final prefs = await SharedPreferences
                                            .getInstance();
                                        final notes = prefs.getStringList(
                                                widget.folderName) ??
                                            [];
                                        final modified = prefs.getStringList(
                                                '${widget.folderName}_modified') ??
                                            [];
